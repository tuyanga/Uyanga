...
document.writeln("<p>Цифрүүдийн нийлбэр нь палиндром эсэхийг шалгах програм</p>");
...
document.writeln("<p>Чоно туулайг гүйцэх хугацааг тооцоолох програм</p>");
...
document.writeln("<p>Тоот унших програм</p>");
...
document.writeln("<p>5 тооны хамгийн бага ерөнхий хуваагдагчийг олох програм</p>");
var a=[];
var i=0;
while(i<5){
...
document.writeln("<p>Тооны зэрэг болон язгуур олох програм</p>");
